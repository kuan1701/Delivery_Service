...
public class DeliveryApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Hi, this is a grocery delivery service.\n"
				+ "If you want to start working with the application, enter 1.\n"
		...
		while (startProgram == 1) {
			...
			if (resultStart == 1) {
				...
				int operationResult = scanner.nextInt();
				...
				int changeResult = scanner.nextInt();
				...
				int deleteResult = scanner.nextInt();
				...
				if (deleteResult == 1) {
					...
					int productShopId = scanner.nextInt() - 1;
			...
			System.out.println("If you want to continue working with the application, enter 1.\n"
					+ "If you want to exit, enter 0");
